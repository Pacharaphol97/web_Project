...
export class LeaveComponent implements OnInit {
  ...
  displayedColumns: string[] = ['id','fullname','leave','action'];
  dataloading = false
  dataAllPersonnel
  ...
  personnelLeave(element){
    this.router.navigate(['personnelleave'],{queryParams: {dataPersonnel:JSON.stringify(element)}})
  }
